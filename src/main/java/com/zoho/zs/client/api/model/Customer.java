...
public class Customer extends Resource
{
	...
	public static Card addCard(Customer customer, String id) throws ZSAPIException
	{
		return ResourceUtil.process(RequestMethod.POST, instancePath(Customer.class, id) + "/cards", Card.class, customer);
	}

	public static BankAccount addBankAccount(Customer customer, String id) throws ZSAPIException
	{
		return ResourceUtil.process(RequestMethod.POST, instancePath(Customer.class, id) + "/bankaccounts", BankAccount.class, customer);
	}

	public static Card updateCard(Customer customer, String id, String cardId) throws ZSAPIException
	{
		return ResourceUtil.process(RequestMethod.POST, instancePath(Customer.class, id) + "/cards/" + cardId, Card.class, customer);
	}

	public static BankAccount updateBankAccount(BankAccount bankAccount, String id, String accountId) throws ZSAPIException
	{
		return ResourceUtil.process(RequestMethod.POST, instancePath(Customer.class, id) + "/bankaccounts/" + accountId, BankAccount.class, bankAccount);
	}
	...
	public Short getVatTreatment()
	{
		return vatTreatment;
	}

	public void setVatTreatment(Short vatTreatment)
	{
