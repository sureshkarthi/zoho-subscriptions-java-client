...
public class Subscription extends Resource
{
	...
	public static Subscription deleteCoupons(String subscriptionId) throws ZSAPIException
	{
		return ResourceUtil.process(RequestMethod.DELETE, instancePath(Subscription.class, subscriptionId) + "/" + classPath(Coupon.class), Subscription.class);
	}
	...
	@JsonProperty
	public void setIncludeSetupFee(Boolean includeSetupFee)
	{
		this.includeSetupFee = includeSetupFee;
	}

	@JsonIgnore
	public Boolean getIncludeSetupFee()
	{
		return includeSetupFee;
	}
